...
- **🤖 Smart SMS Parsing** — <!-- BANKS_SUMMARY -->144 banks across 23 countries<!-- /BANKS_SUMMARY --> with real-time detection of incoming SMS
...
Supporting **144 banks & services** across **23 countries** with **multi-currency** capabilities:
...
### 🇸🇦 Saudi Arabia — SAR ﷼ (8)
**Al Rajhi Bank**, **Alinma Bank**, **Barq**, **D360 Bank**, **Mobily Pay**, **SABB**, **STC Bank**, **Saudi National Bank**
